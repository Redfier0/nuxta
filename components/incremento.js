...
const incremento = {
    incremento: (req, res, next) => {
        ...
        con.query("SELECT * FROM isole WHERE id = ?", [id_isola], (error, result) => {
            let evoluzione = result[0].evoluzione
                ...
                con.query("SELECT * FROM persone WHERE id_isola = ?", [id_isola], async(error, result) => {
                    ...
                    con.query("SELECT * FROM acqua WHERE id_isola = ?", [id_isola], async(error, result) => {
                        ...
                        con.query("SELECT * FROM strutture WHERE id_isola = ?", [id_isola], async(error, result) => {
                            ...
                            const quantitaAcqaFiume = evoluzione * strutture[3].quantita
                            const quantitaAcqaPozzo = (evoluzione - 2) * strutture[2].quantita
                            const aggiungiAcqua = quantitaAcqaFiume + quantitaAcqaPozzo
                            const quantitaMassimaCasa = strutture[0].quantita * (3 * evoluzione)
