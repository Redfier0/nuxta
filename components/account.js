            ...
            if (wallet && nome && password) {
                ...
                con.query("INSERT INTO account (wallet, password) VALUES (?, ?)", [wallet, newPsw], (error, result) => {
                    ...
                    con.query("INSERT INTO isole (id_account, colore, nome) VALUES (?, ?, ?)", [id, codiceColore, nome], (error, result) => {
                        ...
                        con.query("INSERT INTO acqua (id_isola, id_categoria, quantita, quantita_acquistato) VALUES (?, ?, ?, ?)", [id_isola, 1, 75, 1], (error, result) => {})
                        con.query("INSERT INTO persone (id_isola, id_categoria, quantita, quantita_acquistato) VALUES (?, ?, ?, ?)", [id_isola, 1, 6, 1], (error, result) => {})
                        con.query("INSERT INTO strutture (id_isola, id_categoria, quantita, quantita_acquistato) VALUES (?, ?, ?, ?)", [id_isola, 1, 1, 1], (error, result) => {})
                        con.query("INSERT INTO strutture (id_isola, id_categoria, quantita) VALUES (?, ?, ?)", [id_isola, 2, 0], (error, result) => {})
                        con.query("INSERT INTO strutture (id_isola, id_categoria, quantita, quantita_acquistato ) VALUES (?, ?, ?)", [id_isola, 3, 1, 1], (error, result) => {})
                        con.query("INSERT INTO strutture (id_isola, id_categoria, quantita, quantita_acquistato) VALUES (?, ?, ?, ?)", [id_isola, 4, 1, 1], (error, result) => {})
                    })
                })
            }
            return res.redirect("/login")
